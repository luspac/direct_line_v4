...
var models_1$2 = models$2.ChoiceModel;
var models_2$1 = models$2.BooleanModel;
...
var extractors_1$2 = extractors$2.ChoiceExtractor;
var extractors_2 = extractors$2.BooleanExtractor;
...
var parsers_1$2 = parsers$2.ChoiceParser;
var parsers_2 = parsers$2.BooleanParser;
...
(function (EnglishChoice) {
    ...
    EnglishChoice.TrueRegex = `\\b(true|yes|yep|y|sure|ok)\\b|(\\uD83D\\uDC4D|\\uD83D\\uDC4C)`;
    EnglishChoice.FalseRegex = `\\b(false|nope|nop|no)\\b|(\\uD83D\\uDC4E|\\u270B|\\uD83D\\uDD90)`;
})(EnglishChoice = exports.EnglishChoice || (exports.EnglishChoice = {}));

});

unwrapExports(englishChoice);
var englishChoice_1 = englishChoice.EnglishChoice;
...
class EnglishBooleanExtractorConfiguration {
    constructor(onlyTopMatch = true) {
        this.regexTrue = recognizersText.RegExpUtility.getSafeRegExp(englishChoice.EnglishChoice.TrueRegex);
        this.regexFalse = recognizersText.RegExpUtility.getSafeRegExp(englishChoice.EnglishChoice.FalseRegex);
        this.tokenRegex = recognizersText.RegExpUtility.getSafeRegExp(englishChoice.EnglishChoice.TokenizerRegex, 'is');
...
var boolean_2 = boolean_1.EnglishBooleanExtractorConfiguration;
...
function recognizeBoolean(query, culture, options = ChoiceOptions.None, fallbackToDefaultCulture = true) {
...
class OptionsRecognizer extends recognizersText.Recognizer {
    constructor(culture, options = ChoiceOptions.None, lazyInitialization = false) {
        super(culture, options, lazyInitialization);
    }
    InitializeConfiguration() {
        //#region English
        this.registerModel("BooleanModel", recognizersText.Culture.English, (options) => new models$2.BooleanModel(new parsers$2.BooleanParser(), new extractors$2.BooleanExtractor(new boolean_1.EnglishBooleanExtractorConfiguration())));
        //#endregion
    }
...
var choiceRecognizer_1 = choiceRecognizer.ChoiceOptions;
var choiceRecognizer_2 = choiceRecognizer.recognizeBoolean;
...
var recognizersTextChoice_12 = recognizersTextChoice.EnglishBooleanExtractorConfiguration;
var recognizersTextChoice_13 = recognizersTextChoice.EnglishChoice;

export default recognizersTextChoice$1;
export { recognizersTextChoice_1 as ChoiceRecognizer, recognizersTextChoice_2 as ChoiceOptions, recognizersTextChoice_3 as recognizeBoolean, recognizersTextChoice_4 as Culture, recognizersTextChoice_5 as Constants, recognizersTextChoice_6 as ChoiceModel, recognizersTextChoice_7 as BooleanModel, recognizersTextChoice_8 as ChoiceExtractor, recognizersTextChoice_9 as BooleanExtractor, recognizersTextChoice_10 as ChoiceParser, recognizersTextChoice_11 as BooleanParser, recognizersTextChoice_12 as EnglishBooleanExtractorConfiguration, recognizersTextChoice_13 as EnglishChoice };
