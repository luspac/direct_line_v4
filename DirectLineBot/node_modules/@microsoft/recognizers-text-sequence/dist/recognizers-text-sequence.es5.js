...
var culture_1 = culture.Culture;
var culture_2 = culture.CultureInfo;
...
class RegExpUtility {
    static getMatches(regex, source) {
        ...
        while (startPos >= 0) {
            ...
            let nlbRegex = xregexpAll(rawRegex.substring(startPos, closePos + 1), 'gis');
            let nextRegex = RegExpUtility.getNextRegex(rawRegex, startPos);
            nlbRegex.nextRegex = nextRegex ? xregexpAll(nextRegex, 'gis') : null;
        ...
        let tempRegex = xregexpAll(rawRegex, 'gis');
    ...
    static getMatchesSimple(regex, source) {
        ...
        xregexpAll.forEach(normalized, regex, match => {
    ...
    static getSafeRegExp(source, flags) {
        ...
        return xregexpAll(sanitizedSource, flags || 'gis');
    }
    ...
    static split(regex, source) {
        return xregexpAll.split(source, regex);
    }
    ...
    static sanitizeGroups(source) {
        let index = 0;
        let result = xregexpAll.replace(source, this.matchGroup, (match, name) => match.replace(name, `${name}__${index++}`));
        index = 0;
        result = xregexpAll.replace(result, this.matchPositiveLookbehind, () => `(?<plb__${index++}>`);
        index = 0;
        result = xregexpAll.replace(result, this.matchNegativeLookbehind, () => `(?<nlb__${index++}>`);
        return result;
    }
...
RegExpUtility.matchGroup = xregexpAll(String.raw `\?<(?<name>\w+)>`, 'gis');
RegExpUtility.matchPositiveLookbehind = xregexpAll(String.raw `\(\?<=`, 'gis');
RegExpUtility.matchNegativeLookbehind = xregexpAll(String.raw `\(\?<!`, 'gis');
...
var utilities_1 = utilities.FormatUtility;
var utilities_2 = utilities.Match;
var utilities_3 = utilities.RegExpUtility;
var utilities_4 = utilities.StringUtility;
...
var models_1 = models.ModelResult;
var models_2 = models.ModelFactory;
...
var recognizer_1 = recognizer.Recognizer;
...
var extractors_1 = extractors.ExtractResult;
...
var parsers_1 = parsers.ParseResult;
...
var models_1$2 = models$2.AbstractSequenceModel;
var models_2$1 = models$2.PhoneNumberModel;
var models_3 = models$2.IpAddressModel;
...
var parsers_1$2 = parsers$2.BaseSequenceParser;
var parsers_2 = parsers$2.BaseIpParser;

var parsers$4 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

class PhoneNumberParser extends parsers$2.BaseSequenceParser {
}
exports.PhoneNumberParser = PhoneNumberParser;
class IpParser extends parsers$2.BaseIpParser {
}
...
var parsers_2$1 = parsers$4.PhoneNumberParser;
var parsers_3 = parsers$4.IpParser;
...
(function (BasePhoneNumbers) {
    ...
    BasePhoneNumbers.GeneralPhoneNumberRegex = `(\\b((\\d[\\s-/]?){7,}\\d)\\b)`;
    BasePhoneNumbers.BrazilPhoneNumberRegex = `(((\\B\\(\\s?))\\d{2,3}(\\s?\\))|(\\b\\d{2,3}))\\s?\\d{4,5}-?\\d{3,5}\\b`;
    BasePhoneNumbers.UkPhoneNumberRegex = `(((\\b(00)|\\B\\+)\\s?)?\\d{2}\\s?(\\(0\\))?\\d{3,5}[/-]?\\s?(\\d{7,8}|\\d{3}\\s?\\d{3})\\b)`;
    BasePhoneNumbers.GermanyPhoneNumberRegex = `(\\b(\\d{4}\\s?[-/]?(\\s?\\d){7,8})\\b)`;
    BasePhoneNumbers.USPhoneNumberRegex = `((((\\B\\+)|\\b)1(\\s|-)?)|\\b)?(\\B\\(|\\b)\\d{3}\\)?\\s?-?\\s?\\d{3}\\s?-?\\s?\\d{4}\\b`;
})(BasePhoneNumbers = exports.BasePhoneNumbers || (exports.BasePhoneNumbers = {}));

});

unwrapExports(basePhoneNumbers);
var basePhoneNumbers_1 = basePhoneNumbers.BasePhoneNumbers;
...
(function (BaseIp) {
    ...
    BaseIp.Ipv6EllipsisRegexOther = `\\B::\\B|\\B:(:${BaseIp.BasicIpv6Element}){0,7}\\b|\\b(${BaseIp.BasicIpv6Element}:){0,7}:\\B`;
...
Constants.PHONE_NUMBER_REGEX_BRAZIL = "BrazilPhoneNumber";
Constants.PHONE_NUMBER_REGEX_UK = "UKPhoneNumber";
Constants.PHONE_NUMBER_REGEX_GERMANY = "GermanyPhoneNumber";
...
class BasePhoneNumberExtractor extends BaseSequenceExtractor {
    constructor() {
        ...
        this.regexes = new Map()
            .set(recognizersText.RegExpUtility.getSafeRegExp(basePhoneNumbers.BasePhoneNumbers.BrazilPhoneNumberRegex), constants.Constants.PHONE_NUMBER_REGEX_BRAZIL)
            .set(recognizersText.RegExpUtility.getSafeRegExp(basePhoneNumbers.BasePhoneNumbers.GeneralPhoneNumberRegex), constants.Constants.PHONE_NUMBER_REGEX_GENERAL)
            .set(recognizersText.RegExpUtility.getSafeRegExp(basePhoneNumbers.BasePhoneNumbers.UkPhoneNumberRegex), constants.Constants.PHONE_NUMBER_REGEX_UK)
            .set(recognizersText.RegExpUtility.getSafeRegExp(basePhoneNumbers.BasePhoneNumbers.GermanyPhoneNumberRegex), constants.Constants.PHONE_NUMBER_REGEX_GERMANY)
            .set(recognizersText.RegExpUtility.getSafeRegExp(basePhoneNumbers.BasePhoneNumbers.USPhoneNumberRegex), constants.Constants.PHONE_NUMBER_REGEX_US);
    }
}
...
class BaseIpExtractor extends BaseSequenceExtractor {
    constructor() {
        super();
        this.regexes = new Map()
            .set(recognizersText.RegExpUtility.getSafeRegExp(baseIp.BaseIp.Ipv4Regex), constants.Constants.IP_REGEX_IPV4)
            .set(recognizersText.RegExpUtility.getSafeRegExp(baseIp.BaseIp.Ipv6Regex), constants.Constants.IP_REGEX_IPV6);
    }
    extract(source) {
        let results = new Array();
        if (recognizersText.StringUtility.isNullOrWhitespace(source)) {
        ...
        for (var i = 0; i < source.length; i++) {
            if (matched[i]) {
                if (i + 1 == source.length || !matched[i + 1]) {
                    ...
                    let length = i - lastNotMatched;
                    let substr = source.substr(start, length);
                    if (substr.startsWith(constants.Constants.IPV6_ELLIPSIS) && start > 0 && this.isLetterOrDigit(source[start - 1])) {
                        continue;
                    }
                    else if (substr.endsWith(constants.Constants.IPV6_ELLIPSIS) && i + 1 < source.length && this.isLetterOrDigit(source[i + 1])) {
                        continue;
                    }
                    let matchFunc = (o) => o.index == start && o.length == length;
                    var srcMatch = Array.from(matchSource.keys()).find(matchFunc);
...
var extractors_1$2 = extractors$2.BaseSequenceExtractor;
var extractors_2 = extractors$2.BasePhoneNumberExtractor;
var extractors_3 = extractors$2.BaseIpExtractor;

var extractors$4 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });

class PhoneNumberExtractor extends extractors$2.BasePhoneNumberExtractor {
}
exports.PhoneNumberExtractor = PhoneNumberExtractor;
class IpExtractor extends extractors$2.BaseIpExtractor {
}
...
var extractors_2$1 = extractors$4.PhoneNumberExtractor;
var extractors_3$1 = extractors$4.IpExtractor;
...
})(SequenceOptions = exports.SequenceOptions || (exports.SequenceOptions = {}));
function recognizePhoneNumber(query, culture, options = SequenceOptions.None) {
...
class SequenceRecognizer extends recognizersText.Recognizer {
    constructor(culture, options = SequenceOptions.None, lazyInitialization = false) {
    ...
    InitializeConfiguration() {
        this.registerModel("PhoneNumberModel", recognizersText.Culture.English, (options) => new models$2.PhoneNumberModel(new parsers$4.PhoneNumberParser(), new extractors$4.PhoneNumberExtractor()));
        this.registerModel("IpAddressModel", recognizersText.Culture.English, (options) => new models$2.IpAddressModel(new parsers$4.IpParser(), new extractors$4.IpExtractor()));
    }
...
var sequenceRecognizer_1 = sequenceRecognizer.SequenceOptions;
var sequenceRecognizer_2 = sequenceRecognizer.recognizePhoneNumber;
var sequenceRecognizer_3 = sequenceRecognizer.recognizeIpAddress;

var phoneNumbers = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
var PhoneNumbers;
(function (PhoneNumbers) {
    PhoneNumbers.NumberReplaceToken = '@builtin.phonenumber';
    PhoneNumbers.GeneralPhoneNumberRegex = `(\\b((\\d[\\s-/]?){8,})\\b)`;
    PhoneNumbers.BrazilPhoneNumberRegex = `(((\\B\\(\\s?)|\\b)\\d{2,3}(\\s?\\))?\\s?)\\s?\\d{4,5}-?\\d{3,5}\\b`;
    PhoneNumbers.UkPhoneNumberRegex = `(((\\b(00)|\\B\\+)\\s?)?\\d{2}\\s?(\\(0\\))?\\d{3,5}[/-]?\\s?(\\d{7,8}|\\d{3}\\s?\\d{3})\\b)`;
    PhoneNumbers.GermanyPhoneNumberRegex = `(\\b(\\d{4}\\s?[-/]?(\\s?\\d){7,8})\\b)`;
    PhoneNumbers.USPhoneNumberRegex = `((((\\B\\+)|\\b)1(\\s|-)?)|\\b)?(\\B\\(|\\b)\\d{3}\\)?\\s?-?\\s?\\d{3}\\s?-?\\s?\\d{4}\\b`;
})(PhoneNumbers = exports.PhoneNumbers || (exports.PhoneNumbers = {}));

});

unwrapExports(phoneNumbers);
var phoneNumbers_1 = phoneNumbers.PhoneNumbers;
...
exports.BaseSequenceExtractor = extractors$2.BaseSequenceExtractor;
exports.BasePhoneNumberExtractor = extractors$2.BasePhoneNumberExtractor;
exports.BaseIpExtractor = extractors$2.BaseIpExtractor;

exports.PhoneNumberExtractor = extractors$4.PhoneNumberExtractor;
exports.IpExtractor = extractors$4.IpExtractor;

exports.BaseSequenceParser = parsers$2.BaseSequenceParser;
exports.BaseIpParser = parsers$2.BaseIpParser;

exports.PhoneNumberParser = parsers$4.PhoneNumberParser;
exports.IpParser = parsers$4.IpParser;

exports.PhoneNumbers = phoneNumbers.PhoneNumbers;
...
var recognizersTextSequence_5 = recognizersTextSequence.Culture;
var recognizersTextSequence_6 = recognizersTextSequence.AbstractSequenceModel;
var recognizersTextSequence_7 = recognizersTextSequence.PhoneNumberModel;
var recognizersTextSequence_8 = recognizersTextSequence.IpAddressModel;
var recognizersTextSequence_9 = recognizersTextSequence.BaseSequenceExtractor;
var recognizersTextSequence_10 = recognizersTextSequence.BasePhoneNumberExtractor;
var recognizersTextSequence_11 = recognizersTextSequence.BaseIpExtractor;
var recognizersTextSequence_12 = recognizersTextSequence.PhoneNumberExtractor;
var recognizersTextSequence_13 = recognizersTextSequence.IpExtractor;
var recognizersTextSequence_14 = recognizersTextSequence.BaseSequenceParser;
var recognizersTextSequence_15 = recognizersTextSequence.BaseIpParser;
var recognizersTextSequence_16 = recognizersTextSequence.PhoneNumberParser;
var recognizersTextSequence_17 = recognizersTextSequence.IpParser;
var recognizersTextSequence_18 = recognizersTextSequence.PhoneNumbers;
var recognizersTextSequence_19 = recognizersTextSequence.BaseIp;

export default recognizersTextSequence$1;
export { recognizersTextSequence_1 as SequenceRecognizer, recognizersTextSequence_2 as SequenceOptions, recognizersTextSequence_3 as recognizePhoneNumber, recognizersTextSequence_4 as recognizeIpAddress, recognizersTextSequence_5 as Culture, recognizersTextSequence_6 as AbstractSequenceModel, recognizersTextSequence_7 as PhoneNumberModel, recognizersTextSequence_8 as IpAddressModel, recognizersTextSequence_9 as BaseSequenceExtractor, recognizersTextSequence_10 as BasePhoneNumberExtractor, recognizersTextSequence_11 as BaseIpExtractor, recognizersTextSequence_12 as PhoneNumberExtractor, recognizersTextSequence_13 as IpExtractor, recognizersTextSequence_14 as BaseSequenceParser, recognizersTextSequence_15 as BaseIpParser, recognizersTextSequence_16 as PhoneNumberParser, recognizersTextSequence_17 as IpParser, recognizersTextSequence_18 as PhoneNumbers, recognizersTextSequence_19 as BaseIp };
